...
import (
	...
	"github.com/chasedut/toke/internal/tui/components/image"
...
func (m *model) Position() (int, int) {
	...
	// Estimate height based on typical file picker size
	dialogHeight := min(20, m.wHeight/2) + 6 // list height + borders/padding
