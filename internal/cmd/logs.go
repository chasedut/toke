...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View toke logs",
	Long:  `View the logs generated by Toke. This command allows you to see the log output for debugging and monitoring.`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		logsFile := filepath.Join(cfg.WorkingDir(), cfg.Options.DataDirectory, "logs", "toke.log")
		_, err = os.Stat(logsFile)
		if os.IsNotExist(err) {
			log.Warn("Looks like you are not in a toke project. No logs found.")
			return nil
		}
